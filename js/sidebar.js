...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //   .pipe(
  //     flatMap(() => combineLatest([prompt$, model$, maxTokens$, temperature$, url$])),
  //     flatMap(([prompt, model, maxTokens, temperature, url]) => makeApiCall(url, model, prompt, maxTokens, temperature))
  //   )
  //   .subscribe(
  //     result => {
  //       if (result.error) {
